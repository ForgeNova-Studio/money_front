...
mixin _$RegisterResponseModel {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, accessToken, refreshToken, expiresIn, userId);

  @override
  String toString() {
    return 'RegisterResponseModel(accessToken: $accessToken, refreshToken: $refreshToken, expiresIn: $expiresIn, userId: $userId)';
  }
}
...
extension RegisterResponseModelPatterns on RegisterResponseModel {
  ...
  TResult? whenOrNull<TResult extends Object?>(
    TResult? Function(String accessToken, String refreshToken,
            String? expiresIn, String userId)?
        $default,
  ) {
    final _that = this;
    switch (_that) {
