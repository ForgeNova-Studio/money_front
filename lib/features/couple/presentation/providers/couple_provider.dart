...
import 'package:moneyflow/features/couple/data/services/couple_api_service.dart';
import '../../domain/entities/couple_model.dart';
...
class CoupleProvider with ChangeNotifier {
  final CoupleApiService _apiService;
  ...
  CoupleProvider({CoupleApiService? apiService})
      : _apiService = apiService ?? CoupleApiService();
